...
import static src.com.chess.engine.board.Move.MajorAttackMove;
import static src.com.chess.engine.board.Move.MajorMove;
...
public final class King extends Piece {
    ...
    public King movePiece(final Move move) {
        return new King(this.pieceColor, move.getDestinationCoordinate(), false, move.isCastlingMove(), false, false);
    }
