...
public class TestPieces {
    ...
    public void testMiddleQueenOnEmptyBoard() {
        ...
        // White Layout
        builder.setPiece(new Queen(Color.WHITE, 36));
    ...
    public void testLegalMoveAllAvailable() {
        ...
        // Black Layout
        boardBuilder.setPiece(new King(Color.BLACK, 4, false, false));
        boardBuilder.setPiece(new Knight(Color.BLACK, 28));
        // White Layout
        boardBuilder.setPiece(new Knight(Color.WHITE, 36));
        boardBuilder.setPiece(new King(Color.WHITE, 60, false, false));
        // Set the current player
        ...
        // Black Layout
        boardBuilder2.setPiece(new King(Color.BLACK, 4, false, false));
        boardBuilder2.setPiece(new Knight(Color.BLACK, 28));
        // White Layout
        boardBuilder2.setPiece(new Knight(Color.WHITE, 36));
        boardBuilder2.setPiece(new King(Color.WHITE, 60, false, false));
        // Set the current player
    ...
    public void testKnightInCorners() {
        final Board.Builder boardBuilder = new Board.Builder();
        boardBuilder.setPiece(new King(Color.BLACK, 4, false, false));
        boardBuilder.setPiece(new Knight(Color.BLACK, 0));
        boardBuilder.setPiece(new Knight(Color.WHITE, 56));
        boardBuilder.setPiece(new King(Color.WHITE, 60, false, false));
        boardBuilder.setMoveMaker(Color.WHITE);
        final Board board = boardBuilder.build();
        final Collection<Move> whiteLegals = board.whitePlayer().getLegalMoves();
    ...
    public void testMiddleBishopOnEmptyBoard() {
        ...
        builder.setPiece(new King(Color.BLACK, 4, false, false));
        // White Layout
        builder.setPiece(new Bishop(Color.WHITE, 35));
        builder.setPiece(new King(Color.WHITE, 60, false, false));
        // Set the current player
        builder.setMoveMaker(Color.WHITE);
        //build the board
    ...
    public void testTopLeftBishopOnEmptyBoard() {
        ...
        builder.setPiece(new King(Color.BLACK, 4, false, false));
        // White Layout
        builder.setPiece(new Bishop(Color.WHITE, 0));
        builder.setPiece(new King(Color.WHITE, 60, false, false));
        // Set the current player
        builder.setMoveMaker(Color.WHITE);
        //build the board
    ...
    public void testTopRightBishopOnEmptyBoard() {
        ...
        builder.setPiece(new King(Color.BLACK, 4, false, false));
        // White Layout
        builder.setPiece(new Bishop(Color.WHITE, 7));
        builder.setPiece(new King(Color.WHITE, 60, false, false));
        // Set the current player
        builder.setMoveMaker(Color.WHITE);
        //build the board
    ...
    public void testBottomLeftBishopOnEmptyBoard() {
        ...
        builder.setPiece(new King(Color.BLACK, 4, false, false));
        // White Layout
        builder.setPiece(new Bishop(Color.WHITE, 56));
        builder.setPiece(new King(Color.WHITE, 60, false, false));
        // Set the current player
        builder.setMoveMaker(Color.WHITE);
        //build the board
    ...
    public void testBottomRightBishopOnEmptyBoard() {
        ...
        builder.setPiece(new King(Color.BLACK, 4, false, false));
        // White Layout
        builder.setPiece(new Bishop(Color.WHITE, 63));
        builder.setPiece(new King(Color.WHITE, 60, false, false));
        // Set the current player
        builder.setMoveMaker(Color.WHITE);
        //build the board
    ...
    public void testPawnPromotion() {
        ...
        builder.setPiece(new King(Color.BLACK, 22, false, false));
        // White Layout
        builder.setPiece(new Pawn(Color.WHITE, 15));
        builder.setPiece(new King(Color.WHITE, 52, false, false));
        // Set the current player
        builder.setMoveMaker(Color.WHITE);
        final Board board = builder.build();
